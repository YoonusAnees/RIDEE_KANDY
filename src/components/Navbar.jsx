...
export default function Navbar() {
  return (
    <nav
      ...
      h-80 md:h-30 p-4 md:px-2 py-2 text-white
      bg-[##1A1A1A40] backdrop-blur-md backdrop-brightness-50"
    >
      <div className="md:max-w-7xl md:mx-auto md:flex justify-between items-center mt-2">
        <div className="h-5 w-5 md:h-12 md:w-20 mb-8">
          <img src="/src/assets/logo.svg" alt="logo" />
        </div>

        <div className="md:flex gap-6 items-center md:text-[18px] justify-evenly font-extralight  font-wasted">
        ...
        <div className="flex items-center justify-start mt-4 md:mt-1 md:text-xl font-wasted">
