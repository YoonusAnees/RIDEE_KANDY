    ...
    <>
      ...
      >
        ...
        <div className="relative max-w-[1250px] mx-auto h-full flex items-center justify-between px-6">
          {/* LOGO */}
          <NavLink to="/" className="w-14 lg:w-16">
            <img
              src={logo}
              alt="Ridee Boutique"
          ...
          <div
            className="
              ...
              font-source-pro font-normal text-[16px] leading-[24px] uppercase
            "
          >
            {navLinks.map((link) => (
              <NavLink
                ...
                className={({ isActive }) => `
      relative tracking-[3px] transition cursor-pointer
          ...
          <div className="flex items-center gap-4">
            <div
              className={`
                ...
                h-[55px] px-[30px]
                border-2
                font-Wasted text-[18px] leading-[24px]
                transition cursor-pointer font-source-pro tracking-[3px]
        ...
        >
          {navLinks.map((link) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `relative text-lg cursor-pointer transition
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span
                    className={`
                block mx-auto mt-2 h-[2px] rounded-full bg-white
                transition-all duration-300
